...
People often miss the /simplicity/ of the HDF5 data model for irrelvant technical
details. HDF5 represents data as (values of) variables and relationships among
them. Isn't that how mathematical models work? If there is any secret sauce to
HDF5, this is it, and it's hidden in plain sight.
